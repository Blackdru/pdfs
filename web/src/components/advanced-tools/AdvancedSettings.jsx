...
const AdvancedSettings = ({
  ...
  return (
    <div className="bg-elevated rounded-2xl p-6 mb-6">
        ...
        <div className="space-y-6">
          ...
          {(selectedTool.id === 'advanced-ocr' || selectedTool.id === 'ai-chat') && (
            <div className="p-4 bg-accent rounded-xl">
              ...
              <div className="mt-4 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    />
                    <span className="text-xs text-muted-foreground">Fix OCR errors with AI</span>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-3">
                    <input
                      ...
                      className="rounded border-grey-500 text-purple-600 focus:ring-purple-500"
                    />
                    <span className="text-xs text-muted-foreground">Multiple enhancement strategies</span>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-3">
                    <input
                      ...
                      className="rounded border-grey-500 text-purple-600 focus:ring-purple-500"
                    />
                    <span className="text-xs text-muted-foreground">Enable AI translation</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-4">
                ...
                <p className="text-xs text-muted-foreground mt-1">Lower = more text extracted, Higher = better accuracy</p>
              </div>
              ...
              <div className="mt-4 space-y-3">
                <div className="flex items-center space-x-3">
                  <input
                    ...
                    className="rounded border-grey-500 text-purple-600 focus:ring-purple-500"
                  />
                  <span className="text-sm text-card-foreground">Optimize embedded images</span>
                </div>
                <div className="flex items-center space-x-3">
                  <input
                    type="checkbox"
                    ...
                    className="rounded border-grey-500 text-purple-600 focus:ring-purple-500"
                  />
                  <span className="text-sm text-card-foreground">Remove metadata for smaller size</span>
                </div>
              </div>
            </div>
          )}
            ...
            <div className="p-4 bg-accent rounded-xl">
              ...
              <div className="mt-4">
                ...
                <input
                  ...
                  className="w-full bg-grey-600 border border-grey-500 text-card-foreground rounded-lg px-3 py-2"
                />
                <p className="text-xs text-muted-foreground mt-1">Use {'{n}'} for part number, {'{page}'} for page number</p>
              </div>
            </div>
          )}
          ...
          {selectedTool.id === 'encrypt-pro' && (
            <div className="p-4 bg-accent rounded-xl">
              ...
              <div className="mt-4 space-y-3">
                <h5 className="text-sm font-medium text-card-foreground">Document Permissions</h5>
                <div className="grid grid-cols-2 gap-3">
                  <div className="flex items-center space-x-3">
                    <input
                      ...
                      className="rounded border-grey-500 text-purple-600 focus:ring-purple-500"
                    />
                    <span className="text-sm text-card-foreground">Allow printing</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <input
                      type="checkbox"
                      ...
                      className="rounded border-grey-500 text-purple-600 focus:ring-purple-500"
                    />
                    <span className="text-sm text-card-foreground">Allow copying</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <input
                      type="checkbox"
                      ...
                      className="rounded border-grey-500 text-purple-600 focus:ring-purple-500"
                    />
                    <span className="text-sm text-card-foreground">Allow editing</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <input
                      type="checkbox"
                      ...
                      className="rounded border-grey-500 text-purple-600 focus:ring-purple-500"
                    />
                    <span className="text-sm text-card-foreground">Allow annotations</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="mt-4 space-y-3">
                <div className="flex items-center space-x-3">
                  <input
                    ...
                    className="rounded border-grey-500 text-purple-600 focus:ring-purple-500"
                  />
                  <span className="text-sm text-card-foreground">Add bookmarks for each document</span>
                </div>
                <div className="flex items-center space-x-3">
                  <input
                    type="checkbox"
                    ...
                    className="rounded border-grey-500 text-purple-600 focus:ring-purple-500"
                  />
                  <span className="text-sm text-card-foreground">Add page numbers</span>
                </div>
                <div className="flex items-center space-x-3">
                  <input
                    type="checkbox"
                    ...
                    className="rounded border-grey-500 text-purple-600 focus:ring-purple-500"
                  />
                  <span className="text-sm text-card-foreground">Optimize for printing</span>
                </div>
              </div>
            </div>
          )}
              ...
              <div className="mt-4 space-y-3">
                <div className="flex items-center space-x-3">
                  <input
                    ...
                    className="rounded border-grey-500 text-purple-600 focus:ring-purple-500"
                  />
                  <span className="text-sm text-card-foreground">Extract key points</span>
                </div>
                <div className="flex items-center space-x-3">
                  <input
                    type="checkbox"
                    ...
                    className="rounded border-grey-500 text-purple-600 focus:ring-purple-500"
                  />
                  <span className="text-sm text-card-foreground">Perform sentiment analysis</span>
                </div>
                <div className="flex items-center space-x-3">
                  <input
                    type="checkbox"
                    ...
                    className="rounded border-grey-500 text-purple-600 focus:ring-purple-500"
                  />
                  <span className="text-sm text-card-foreground">Detect entities and topics</span>
                </div>
              </div>
            </div>
          )}
          ...
          {selectedTool.id === 'images-to-pdf' && (
            <div className="p-4 bg-accent rounded-xl">
              ...
              <div className="mt-4 space-y-3">
                <h5 className="text-sm font-medium text-card-foreground">Image Options</h5>
                <div className="grid grid-cols-2 gap-3">
                  <div className="flex items-center space-x-3">
                    <input
                      type="checkbox"
                      ...
                      className="rounded border-grey-500 text-purple-600 focus:ring-purple-500"
                    />
                    <span className="text-sm text-card-foreground">Fit images to page</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <input
                      type="checkbox"
                      ...
                      className="rounded border-grey-500 text-purple-600 focus:ring-purple-500"
                    />
                    <span className="text-sm text-card-foreground">Center images</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <input
                      type="checkbox"
                  ...
                  <div className="flex items-center space-x-3">
                    <input
                      ...
                      className="rounded border-grey-500 text-purple-600 focus:ring-purple-500"
                    />
                    <span className="text-sm text-card-foreground">Add timestamp</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-4 space-y-3">
                <div className="flex items-center space-x-3">
                  <input
                    ...
                    className="rounded border-grey-500 text-purple-600 focus:ring-purple-500"
                  />
                  <span className="text-sm text-card-foreground">Add timestamp authority</span>
                </div>
                <div className="flex items-center space-x-3">
                  <input
                    type="checkbox"
                    ...
                    className="rounded border-grey-500 text-purple-600 focus:ring-purple-500"
                  />
                  <span className="text-sm text-card-foreground">Make signature visible</span>
                </div>
              </div>
            </div>
          )}
